...
//                 const normalizedData: any = response.data.map(item => ({
//                     id: item._id,
...
//     //         toDelete({success: true, message: 'are you sure to delete it?'})
...
//                 const searchableFields = ['itemNo', 'name', 'description', 'itemName', 'updatedAt', 'lastUsedBy'];
...
//     const randomColor = (currentQuantity: string) => {
//         const color = ['primary', 'secondary', 'success', 'danger', 'warning', 'info'];
//         if (parseInt(currentQuantity, 10) >= 80) {
//             return color[2];
//         } else if (parseInt(currentQuantity, 10) >= 70) {
//             return color[5];
//         } else if (parseInt(currentQuantity, 10) >= 51) {
//             return color[0];
//         } else if (parseInt(currentQuantity, 10) >= 0) {
//             return color[3];
//         }
//     };
...
//                                         <div className={`h-4.0 rounded-full rounded-bl-full text-center text-white text-xs bg-${randomColor(currentQuantity)}`} style={{ width: `${currentQuantity}%` }}>{currentQuantity}</div>
//                                     </div>
//                                 ),
//                             },
//                             {
