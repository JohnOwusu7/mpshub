...
//             const response = dispatch(login({ identityNo, password }));

//             if (response?.payload && response?.payload?.success) {
//                 dispatch(hideLoading());
//                 showMessage({ message: response.payload.message, success: true });
...
//             } else {
//                 dispatch(hideLoading());
//                 showMessage({ message: response.payload.message, success: false });
//             }
//         } catch (error) {
//             dispatch(hideLoading());
//             showMessage({
...
//                 <img src="/assets/images/auth/bg-gradient.png" alt="image" className="-full w-full object-cover" />
//             </div>
